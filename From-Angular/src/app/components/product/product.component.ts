...
export class ProductComponent implements OnInit {
  ...
  debugger;
    ...
    if(orderId == null){
      this.globalService.post('/api/Order').subscribe((response)=>{
        let responseOrder = response as Order;
        let orderNew = responseOrder.id;
        
        localStorage.setItem('orderId', orderNew);
        
        this.globalService.post(`/api/Order/${orderNew}/Product`,this.addProduct).subscribe((response)=>{
          Swal.fire({
            position: 'center',
            icon: 'success',
      ...
      this.globalService.post(`/api/Order/${orderId}/Product`,this.addProduct).subscribe((response)=>{
        Swal.fire({
          position: 'center',
          icon: 'success',
          title: 'Agregado al Carrito',
